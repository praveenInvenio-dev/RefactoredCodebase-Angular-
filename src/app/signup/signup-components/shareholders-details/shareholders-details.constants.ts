    ...
    eng: {
      ...
      shareholder: {
        ...
        err: {
          ...
          enterDateOfBirth: "Enter Birth Date",
          ...
          enterCorrectPercentage: "Enter Correct Percentage",
          entervalidPercentage: "Enter Valid Percentage",
          enterTin: "Enter Tin",
          companyIDMinlength: "Company ID should be 10 digit",
          companyIDStartwith: "Company ID should start with 7",
          copyOfNationalID:"Copy of National ID",
          copyOfIquamaID:"Copy of Iqama ID",
          copyOfCompanyID:"Copy of Company ID",
          copyOfGCCID:"Copy of GCC ID",
          invldDt: "Please enter Valid Date format",
    ...
    arb: {
      ...
      shareholder: {
        ...
        err: {
          ...
          tinNumberMinlength: "الرقم المميز يجب ان يحتوي على 10 ارقام", //Tin Number should be atleast 10 characters long
          ...
          enterCorrectPercentage: "ادخل نسبة صحيحة",
          entervalidPercentage: "ادخل نسبة صحيحة",
          enterTin: "",
          companyIDMinlength: "رقم الشركة يجب أن يتكون من 10 أرقام",
          companyIDStartwith: "رقم الشركة يجب ان يبدا بـرقم 7",
          copyOfNationalID:"نسخة من الهوية الوطنية",
          copyOfIquamaID:"نسخة من الإقامة",
          copyOfCompanyID:"نسخة من السجل التجاري",
          copyOfGCCID:"نسخة من الهوية الوطنية لدول مجلس التعاون",
          invldDt: "الرجاء إدخال التاريخ بصيغة صحيحة",
