    ...
    eng: {
      ...
      consortium: {
        ...
        err: {
          ...
          passExpiry: "Expiry date should not be past date",
          passIssue: "Passport issue date should not be less than date of birth",
          noCommunicationsDetails: "Dear Taxpayer, kindly update your information through the Ministry of Commerce and Investment using the following link",
          GAZTSignpLInk: "https://mci.gov.sa/ar/eservices/Pages/default.aspx"
        ...
        acknowledgement: {
          ...
          registrationSuccessfulMsg: "You have Successfully registered to GAZT Services",
          registrationSuccessfulMsg2: "You have received an SMS with the TIN number",
          registrationSuccessfulMsg3: "You can use the TIN number and the set password to login in future"
        },
        login_link_label: "Go To Login",
        error: "Error",
    ...
    arb: {
      ...
      consortium: {
        ...
        passport: {
          ...
          no: "رقم جواز السفر",
          date: "تاريخ الإصدار",
          expiry: "تاريخ الإتهاء",
          attach: "نسخة من الجواز ",
        },
        c1: {
          title: "تسجيل مؤسسة",
          in1: "الرقم المميز",
        ...
        err: {
          ...
          scstdtfutureDate: "Share Capital Start Date cannot be greater than current date",
          spstdtfutureDate: "Share Profit Start Date cannot be greater than current date",
          validFromFutureDate: "تاريخ البداية لا يمكن ان يكون اكبر من تاريخ اليوم",
          ...
          passExpiry: "تاريخ الإنتهاء يجب ان لايكون اصغر من التاريخ الحال",
          passIssue: "تاريخ إصدار الجواز  يجب ان يكون اكبر من تاريخ الميلاد",
          noCommunicationsDetails: "عزيزي المكلف, يرجى تحديث بياناتك في وزارة التجارة والاستثمار عن طريق الرابط التالي",
          GAZTSignpLInk: "https://mci.gov.sa/ar/eservices/Pages/default.aspx"
        },
        c6: {
        ...
        acknowledgement: {
          ...
          registrationSuccessfulMsg: "لقد تم التسجيل بنجاح في خدمات الهيئة العامة للزكاة والدخل",
          registrationSuccessfulMsg2: "تم إرسال رسالة نصية قصيرة تحوي الرقم المميز",
          registrationSuccessfulMsg3: "يمكنك استخدام الرقم المميز وكلمة المرور المُدخله مسبقاً لتسجيل الدخول في المستقبل"
        },
        login_link_label: "الذهاب لصفحة الدخول",
        error: "خطأ",
        accounting: "حسابات",
