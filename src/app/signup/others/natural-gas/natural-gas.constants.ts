export const naturalGasConstants = {
  langz: {
    eng: {
      dir: "ltr",
      consortium: {
        title: "Natural Gas Company",
        header: {
        ...
        err: {
          ...
          enterConfirmEmail: "Please enter Email Address",
          ...
          companyIdErr:"Company ID entered is not related to Natural Gas "
        },
        c6: {
    ...
    arb: {
      ...
      consortium: {
        ...
        err: {
          ...
          companyIdErr:"معرف الشركة الذي تم إدخاله ليس له علاقة بالغاز الطبيعي"
        },
        c6: {
