        ...
        vatDetails:{
          ...
          step2:{
            ...
            block:{
              ...
              radio1:"Yes",
              radio2:"No",
              p:"Do you have sales or purchases subject to 5% VAT as per the transitional provisions or sales, purchases, imports and adjustments subject to 5% VAT that you would like to declare in this period?"
            },
            btn1:"Save As Draft",
            btn2:"Continue",
            btn3:"Cancel"
          ...
          step3:{
            ...
            block:{
              ...
              tr3:"Imports Subject to VAT accounted for through the reverse charge mechanism",
              tr31:"Imports subject to VAT accounted for through the reverse charge mechanism",
          ...
          step6:{
            ...
            subtitle1:"VAT Return Amount Will Be Refunded To The Selected Account",
            i1:"Return Reference Number",
            i2:"Taxable Period",
            i3:"SADAD Number",
            i4:"Amount Payable",
            msg:"By paying the invocie, GAZT Zakat certificate will be issued to you automatically in case there are no other outstanding obligations. Paying the Invoice means you confirm the correctness of the return information.",
          ...
          infoModal:{
            ...
            t2:"Amount (SAR)",
            p1:"Total amount of standard rated goods and services (excluding VAT paid) supplied during the current period that were sold in KSA, in addition to, nominal supplies and supplies subject to margin scheme.",
            p2:"• Please refer to the below FAQ URL for standard rated",
            p5:".00 % goods and services.",
            t3:"Adjustments (SAR)",
            p3:"Total amount of supplies adjustments (excluding VAT paid) made to the previous reporting periods supplies that were sold in KSA, in addition to, nominal supplies and supplies subject to margin scheme.",
            p4:"• For example, return of goods and services by customers on which you have paid VAT to GAZT, write off of bad debt on standard rated receivables",
            a1:"Go to FAQs",
            btn1:"Done"
          },
          step12:{
            ...
            btn1:"Add Attachment",
            l1:"max",
            span:"Caution, you must adjust the settings of the scanner so that the compressed files size less than 50MB. Single file size no exceeds 5MB. (Choose only file with extension .XLS, .XLSX, .DOC, .DOCX, .PDF, .JPG, .JPEG & .PNG)",
            btn2:"Skip",
            btn3:"Continue"
          },
          step13:{
          ...
          Errormessages:{
            ...
            error2:"Range of value allowed is 0 to 999,999,999,999,99.99",
            correctionError:"Kindly submit a self-amendment form for corrections >= -5000 Value SAR or <= 5000 Value SAR"
          },
          CorrectionsModal:{
            t1:"Corrections From Previous Periods",
            p1:"If corrections to the previous return entail a VAT liability adjustment less than  SAR <5,000> or VAT credit position of greater than SAR <-5,000>, then specify the VAT adjustment (and not supplies or purchases amount) in this field. For any other VAT adjustments, please submit a 'Self-Amendment' form",
            btn1:"Done"
          },
          ReviewModal:{
            p1:"Please review calculations in summary screen and press Confirm & Generate SADAD Bill",
            btn:"Ok"
          },
          ...
          SuccessModal:{
            p1:"VAT Return Form Saved successfully",
            btn1:"Ok"
          },
          VoidModal:{
            p1:"All the information filled in the form will be lost. Please confirm if you still want to cancel form.",
            p2:"VAT Return Form is cancelled. Please initiate the process again to file VAT Return",
            btn1:"Ok",
            btn2:"Cancel"
          }
        },
        ...
        vatDetails:{
          step1:{
            ...
            block1:{
              title:"تفاصيل المكلف",
              i1:"الرقم المميز",
              i2:"رقم حساب ضريبة القيمة المضافة",
              i3:"رقم الهوية",
              i4:"اسم المكلف",
              i5:"العنوان",
            },
          ...
          step2:{
            ...
            block:{
              ...
              tr2:"المبيعات للمواطنين (الخدمات الصحية الخاصة/التعليم الأهلي الخاص)",
              ...
              radio1:"نعم",
              radio2:"لا",
              p:"هل لديك مبيعات او مشتريات خاضعة لنسبة ٥٪؜ وفقاً للأحكام الانتقالية او مبيعات او مشتريات او استيرادات او تعديلاتها خاضعة لنسبة ٥٪؜ وتود الإقرار عنها خلال هذه الفترة؟"
            },
            btn1:"حفظ كمسودة",
            btn2:"التالي",
            btn3:"إلغاء"
          ...
          step3:{
            ...
            subTitle:"الرجاء إكمال البيانات التالية",
            block:{
              tableHeading1:"المشتريات",
              tableHeading2:"المبلغ (ريال)",
              tableHeading3:"مبلغ التعديل (ريال)",
              tr1:" المشتريات الخاضعة للنسبة الأساسية ",
              tr11:" المشتريات الخاضعة لنسبة",
              tr2:" الاستيرادات الخاضعة لضريبة القيمة المضافة  بالنسبة الأساسية و التي تدفع في الجمارك",
              tr21:" الاستيرادات الخاضعة لضريبة القيمة المضافة والتي تدفع في الجمارك",
              tr3:" الاستيرادات الخاضعة لضريبة القيمة المضافة التي تُطبق عليها آلية الاحتساب العكسي",
              tr31:" الاستيرادات الخاضعة لضريبة القيمة المضافة التي تُطبق عليها آلية الاحتساب العكسي",
          ...
          step4:{
            ...
            subTitle:"الرجاء إكمال البيانات التالية",
            block:{
              i1:"إجمالي ضريبة القيمة المضافة المستحقة عن الفترة الضريبية  الحالية",
              i2:"ضريبة القيمة المضافة التي تم ترحيلها من الفترة / الفترات السابقة",
          ...
          step6:{
            ...
            title1:" تقر الهيئة العامة للزكاة والدخل بتقديم إقرارك",
            subtitle:"تقر الهيئة العامة للزكاة والدخل بتقديم ودفع الإقرار",
            subtitle1:"سيتم ايداع مبلغ إسترداد ضريبة القيمة المضافة إلى الحساب المحدد",
            i1:"الرقم المرجعي للإقرار",
            i2:"الفترة الضريبية",
            i3:"رقم سداد",
            i4:"المبلغ المستحق (يتضمن الغرامات)",
            msg:"من خلال دفع الفاتورة ، سيتم إصدار شهادة الزكاة من الهيئة العامة للزكاة والدخل لك تلقائيًا في حالة عدم وجود التزامات أخرى معلقة. دفع الفاتورة يعني تأكيدك على صحة معلومات الإرجاع.",
          ...
          modalCorrections:{
            title:"ضريبة القيمة المضافة التي تم ترحيلها من الفترة / الفترات السابقة",
            th1:"الرقم",
          ...
          infoModal:{
            ...
            t2:"المبلغ (ريال)",
            p1:" '• المبلغ الإجمالي لتوريدات السلع والخدمات الخاضعة للضريبة بالنسبة الأساسية (غير شامل ضريبة القيمة المضافة ) التي تم توريدها خلال الفترة الحالية والتي بيعت في المملكة العربية السعودية بالإضافة إلى : - التوريدات المفترضة. -التوريدات الخاضعة لطريقة هامش الربح.",
            p2:"• يرجى الرجوع إلى رابط الأسئلة الشائعة  في الاسفل لمعرفة المزيد حول السلع والخدمات الخاضعة للنسبة الأساسية ",
            p5:"(%)",
            t3:"مبلغ التعديل (ريال)",
            p3:"• المبلغ الإجمالي للتعديلات التي تم إجراؤها على التوريدات (غير شامل ضريبة القيمة المضافة ) المباعة في المملكة العربية السعودية خلال الفترات الضريبية السابقة بالإضافة إلى : - التوريدات المفترضة.  - التوريدات الخاضعة لطريقة هامش الربح ",
            p4:"• على سبيل المثال، إرجاع العملاء للسلع والخدمات التي استحقت عنها ضريبة القيمة المضافة للهيئة العامة للزكاة والدخل، شطب الديون المعدومة على الذمم المدينة الخاضعة للضريبة بالنسبة الأساسية",
          ...
          step12:{
            ...
            btn1:"إضافة مرفق",
            l1:"الحد الأعلى",
            span:"تحذير ، يجب عليك ضبط إعدادات الماسح الضوئي بحيث لا يتجاوز حجم الملف المضغوط أقل من 50 ميجا بايت ، ولا يتجاوز حجم الملف الواحد 5 ميجا بايت. (اختر ملفًا بملحق .XLS ، .XLSX ، .DOC ، .DOCX ، .PDF ، .JPG و .JPEG و .PNG)",
            btn2:"تجاهل",
            btn3:"التالي"
          },
          step13:{
          ...
          Errormessages:{
            ...
            error1:"99,نطاق القيمة المسموح بها هو من 0 الى 999,999,999,999.99",
            correctionError:"يرجى تقديم نموذج تعديل ذاتي للتعديلات الأكثر من أو تساوي  5000 ريال  أو أقل من أو تساوي -5000 ريال"
          },
          CorrectionsModal:{
            t1:"تصحيحات على الفترات السابقة",
            p1:'• اذا كانت تصحيحات الإقرار السابق تستلزم تعديل الالتزام الضريبي   أقل من <5,000> ريال أو رصيد دائن  لأكثر من <-5,000> ريال ، يرجى تحديد التعديل الضريبي (وليست مبالغ توريدات أو  مشتريات) في هذا الحقل. لأي تعديلات ضريبية أخرى يرجى تقديم نموذج "تعديل ذاتي"',
            btn1:"تم"
          },
          ReviewModal:{
            p1:"الرجاء مراجعة الحسابات  في شاشة الملخص و الضغط على التأكيد و إصدار فاتورة سداد",
            btn:"حسنا"
          },
          AdjustmentAmountModal:{
            title:"مبلغ التعديل",
          ...
          SuccessModal:{
            p1:"تم حفظ نموذج إقرار ضريبة القيمة المضافة بنجاح",
            btn1:"حسنا"
          },
          VoidModal:{
            p1:"سيتم مسح جميع المعلومات في النموذج، يرجى التأكيد اذا كنت تريد إلغاء النموذج",
            p2:"نموذج الإقرار غير مقبول. يرجى البدء بالعملية مجددا لتقديم إقرار ضريبي",
            btn1:"حسنا",
            btn2:"إلغاء"
          }
        },
