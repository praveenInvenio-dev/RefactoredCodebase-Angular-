export const excisetaxconstants = {
  langz: {
    eng: {
      dir: "ltr",
      otp: {
      ...
      newReturnsET:
      {
        ...
        c2:{
          step1:{
            ...
            p3:"Back",
            t1:"Excise Returns",
            st1:"Please review and confirm the registration details are correct",
            l1:"Number",
          ...
          step2:{
            h1:"Excise Details",
            st1:"Please review and confirm the income and main activity details are correct",
            th1:"Product Type",
            th2:"Total RSP Value",
            ...
            l13:"Please check if return is Zero Return without excise tax input deduction",
            btn1:"Save Draft",
            btn2:"Confirm"
          },        
          infomodal:{
          ...
          step3:{
            ...
            p1:"I am the undersigned certify the correctness of all amounts declared in this return and they are the Excise tax amounts payable during the above financial year calculated in accordance with the Saudi Income Tax Law and it’s Implementation Regulations.",
            btn1:"Save Draft",
            btn2:"Continue"
          },
          step4:{
          ...
          tcModal:{
            ...
            p1:"This is assumed that the taxpayer has read all the Excise Tax Laws and Regulations of Kingdom of Saudi Arabia and all the information provided in this return is correct.",
            p2:"GAZT has the right to ask and obtain any financial or administrative information and records of the taxpayer and his business to cross-check and verify the information provided in this return.",
            p3:"GAZT has the right to initiate the audit and assessment process for verifying this excise tax return which may result in levy of fines, extra excise tax or any other penalties as per the Laws and Regulations of the Kingdom of Saudi Arabia.",
            p4:"After submitting the return, if the taxpayer finds that he has paid lesser excise tax for the period, he can amend the return by excise tax amendment process, if he is eligible for the same. If he finds that he has paid more excise tax, he can claim it through the excise tax refund process.",
            btn1:"Done"
          },
          step5:{
            ...
            l3:"SADAD Number",
            l4:"Amount Payable",
            p1:"You will receive a detailed breakdown of payable amount on your registered email and in correspondence section of your account on GAZT portal.",
            p2:"For further information, please contact helpdesk",
            p3:"GAZT reserves the right to investigate your return form further.",
            btn1:"Refresh",
          ...
          step6:{
            heading:"Attachments(Optional)",
            btn:"Add Attachment",
            p1:"Caution, you must adjust the settings of the scanner so that the compressed files size less than 10MB. Single file size no exceeds 2MB. (Choose only file with extension .XLS, .XLSX, .DOC, .DOCX, .PDF, .JPG, .JPEG & .PNG)",
            btn1:"Skip",
            btn2:"Continue"
          },
          zeroRateModal:{
            p:"Please confirm if you want to make Zero Return without excise tax input deduction",
            btn1:"Ok",
            btn2:"Cancel"
          },
          infoModal1:{
            p:"Please select checkbox on Step 2 to confirm return is a zero return"
          },
          SuccessModal:{
            p1:"Excise Return Form Saved successfully",
            btn1:"Ok"
          },
          voidModal:{
            p1:"All the information filled in the form will be lost. Please confirm if you still want to cancel form",
            p2:"Excise Return Form is cancelled. Please initiate the process again to file Excise Tax Return",
            btn1:"Ok",
            btn2:"Cancel"
          }
        }
      ...
      newReturnsET:
      {
        ...
        c2:{
          ...
          step2:{
            ...
            st1:"الرجاء المراجعة والتأكد من صحة بيانات النشاط",
            th1:"نوع السلعة",
            th2:"مبلغ سعر البيع",
            th3:"قيمة الضريبة الانتقائية",
            th4:"خصم الضريبة الانتقائية*",
            er1:"نطاق القيمة المسموح بها هو من 0 الى 999,999,999,999.99",
            er2:"يجب أن لاتزيد قيمة خصم الضريبة الأنتقائية عن قيمة الضريبة الأنتقائية",
            er3:"الضريبة الانتقائية الواجب دفعها يجب ان لا تكون أكثر من 99,999,999,999.99",
            l1:"المجموع",
            l2:"المبلغ الإجمالي",
            l3:"صافي الضريبة الانتقائية",
            l4:"الضريبة الانتقائية",
            l5:"خصم الضريبة الانتقائية",
            l6:"صافي الضريبة الانتقائية بعد الخصم",
            l7:"مبلغ الضريبة المستحقة",
            ...
            l13:"الرجاء الاختيار اذا كان الاقرار صفري بدون خصم الضريبة الانتقائية",
            btn1:"حفظ كمسودة",
            btn2:"التأكيد"
          },        
          infomodal:{
            p1:"إجمالي سعر البيع شامل قيمة الضريبة الإنتقائية وقبل احتساب ضريبة القيمة المضافة",
            btn1:"تم"
          },
          step3:{
            h1:"التعهد: ",
            ...
            p1:"أنا الموقع أدناه أشهد على صحة جميع المبالغ المعلنة في هذا الإقرار وهي مبالغ الضريبة الانتقائية المستحقة الدفع خلال السنة المالية المذكورة أعلاه والمحسوبة وفقًا لقانون ضريبة الدخل السعودي ولوائحه التنفيذية .",
            btn1:"حفظ كمسودة",
            btn2:"التالي"
          },
          step4:{
            ...
            l1:"صافي الضريبة بعد خصم المدخلات ",
            l2:"الضريبة الانتقائية الواجب دفعها",
            l3:"التعهد:",
            l4:"تعديل",
            l5:"أوفق على التالي",
            a1:"التعليمات والشروط",
            btn1:"تأكيد و إصدار فاتورة سداد",
            btn2:"تعديل"
          },
          tcModal:{
            t1:"التعليمات والشروط",
            p1:" يفترض أن يكون المكلف قد اطلع على قانون وتشريعات الضريبة الانتقائية للمملكة العربية السعودية وجميع المعلومات المقدمة في هذا الإقرار صحيحة",
            p2:"للهيئة العامة للزكاة والدخل الحق في طلب والحصول على أي معلومات وتقارير مالية أو إدارية خاصة بالعمل التجاري للمكلف للتحقق من المعلومات المقدمة في هذا الإقرار",
            p3:"للهيئة العامة للزكاة والدخل الحق في الشروع في عملية تدقيق الحسابات والتقدير لتتحقق من إقرار الضريبة الانتقائية مما يؤدي الى فرض غرامات , ضرائب انتقائية إضافية , أو غرامات على حسب نظام وتشريعات المملكة العربية السعودية.",
            p4:"يسمح للمكلف بالتعديل بعد تقديم الإقرار إذا وجد المكلف أن الضريبة الانتقائية أقل من قيمة الضريبة المستحقة. كذلك فإن للمكلف الحق في أن يطالب بالمبالغ المسددة بالزيادة عن طريق عملية إعادة المال للضريبة الانتقائية اذا تم سداد ضريبة انتقائية اكثر من قيمة الضريبة المستحقة.",
            btn1:"تم"
          },
          step5:{
            heading:"تأكيد الاستلام",
            h1:"تم استلام إقرار ضريبة السلع الانتقائية بنجاح",
            st1:"تقر الهيئة العامة للزكاة والدخل بتقديم إقرارك",
            l1:"رقم الإقرار المرجعي",
            l2:"الفترة الضريبية",
            l3:"رقم سداد",
            l4:"المبلغ المستحق",
            p1:"ستتلقى بيانًا تفصيليًا بالمبلغ المستحق الدفع على بريدك الإلكتروني المسجل وفي قسم المراسلات بحسابك على بوابة الهيئة العامة للزكاة والدخل.",
            p2:"لمزيد من المعلومات، يرجى الاتصال بمكتب الدعم الفني",
            p3:"تحتفظ الهيئة بحق إجراء مزيد من التحقيق لنموذج الإقرار الخاص بك",
            btn1:"تحديث",
          ...
          step6:{
            heading:"المرفقات (إختياري)",
            btn:"إضافة مرفق",
            p1:"تحذير ، يجب عليك ضبط إعدادات الماسح الضوئي بحيث لا يتجاوز حجم الملف المضغوط أقل من 10 ميجا بايت ، ولا يتجاوز حجم الملف الواحد 2 ميجا بايت. (اختر ملفًا بملحق .XLS ، .XLSX ، .DOC ، .DOCX ، .PDF ، .JPG و .JPEG و .PNG)",
            btn1:"تجاهل",
            btn2:"التالي"
          },
          zeroRateModal:{
            p:"الرجاء التأكيد إذا كنت تريد تقديم إقرار صفري بدون خصم مدخلات الضريبة الانتقائية",
            btn1:"تقديم إعتراض",
            btn2:"الغاء"
          },
          infoModal1:{
            p:"الرجاء اختيار مربع الاختيار في الخطوة الثانية لتأكيد أن الاقرار هو اقرار صفري"
          },
          SuccessModal:{
            p1:"تم حفظ نموذج اقرار الضريبة الانتقائية بنجاح",
            btn1:"حسنا"
          },
          voidModal:{
            p1:"سيتم مسح جميع المعلومات في النموذج , الرجاء التأكيد اذا كنت تريد إلغاء النموذج",
            p2:"تم إلغاء نموذج إقرار الضريبة الانتقائية ، الرجاء البدء في عملية تقديم الضريبة الانتقائية من جديد",
            btn1:"حسنا",
            btn2:"إلغاء"
          }
        }
