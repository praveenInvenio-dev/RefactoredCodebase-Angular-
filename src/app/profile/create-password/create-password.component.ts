...
export class CreatePasswordComponent implements OnInit {
  ...
  completed: EventEmitter<Object> = new EventEmitter<Object>();
  ...
  onSubmit() {
    ...
    this.pwdObj["pwd"] = this.passwordForm.get("pwd").value;
    this.pwdObj["currentPwd"] = this.passwordForm.get("currentPwd").value;
    this.completed.emit(this.pwdObj);
  }
