export const vatderegistrationconstants = {
    langz: {
      eng: {
        dir: "ltr",
        otp: {
        ...
        { 
         nav:{
            t1:"Tax Management > ",
            t2:"VAT De-registration Details",
            t3:"Back",
            t4:"VAT Services>"
         },
         nav1:{
          ...
          max:"5MB max",
          filevalidationmsg:"Please upload less than 5MB",
          fileformatsupportmsg:"file support DOC, DOCX, XLS, XLSX, PDF, JPG",
          ok:"Ok",
          fileAttachType:"Please select Attachment Type"
         },
         step1:{
            t1:"De-registration Details",
            t2:"Complete the below details",
            t3:"Request Type",
            t4:"De-registration of VAT Account",
            t5:"VAT Return Filing Obligation Suspension",
            t6:"Start Date",
            t7:"End Date",
            t8:"End Date cannot be less or same as the Start Date",
            t9:"Suspended filing period",
            t10:"Next filing period",
            t11:"Next filing due date",
            t12:"Reason",
            t13:"If Others (Please Specify)",
            btn1:"Continue",
            btn2:"Save as Draft",
            t14:"Suspension Date must be 1 day ahead of Last ICR date",
            t15:"No icr created for VAT contract object",
            taxpayer1:"Taxpayer Details",
            taxpayer2:"TIN",
            taxpayer3:"Name",
            taxpayer4:"Main Outlet",
            taxpayer5:"CR License",
            taxpayer6:"Address",
            taxpayer7:"VAT Taxable Date",
        popup1:{
            t1:"Instructions & Conditions",
            t2:"Information",
            t3:"If you are deregistering due to Bankruptcy, Liquidation, Merger or Acquisition or any other Reason(s) which relates to all tax types, please proceed with the general Taxpayer's deregistration process which is available from GAZT Portal.",
            t4:"Please fill the requested information for each step. The application cannot be successfully submitted until all of the mandatory fields and attachments have been completed.",
            t5:"Applicant should ensure that there is no pending return filing or any outstanding payment or pending application from his side before submitting this application.",
            t6:"I agree with these Instructions and Conditions and can not choose the checkbox to start submitting the form.",
            btn:"VAT De-registration",
            },
            
         },
         step2:{
            t1:"Attachments",
            t2:"Select the type of document",
            t3:"Attachment Type",
            t4:"Add New Attachment Type",
            btn1:"Continue",
            btn2:"Save as Draft",
            ins1:"Information",
            ins2:"File size should be less than 5 MB",         
            ins3:"The maximum number of attachments that can be uploaded is 5",               
            ins4:"Choose only file with extension DOC, DOCX, XLS, XLSX, PDF, JPG",
         },
        step3:{
            t1:"Declaration",
            t2:"Complete the below details",
            t3:"ID Type",
            t4:"ID Number",
            t41:"Only Digits allowed",
            t42:"Minimum 8 Digits",
            t43:"Maximum 16 Digits",
            t5:"Date",
            t6:"Contact Person Name",
            t61:"Only alphabets allowed",
            t7:"I hereby certify that i am authorized to complete this form for the taxable person and that all information contained is correct.",
            btn1:"Continue",
            btn2:"Save as Draft",
            placeholder1:"Enter Id Number",
            placeholder2:"Enter Contact Person Name",
            placeholder3:"Choose Date",
            placeholder4:"Choose Start Date",
            placeholder5:"Choose End Date",
            already:"Already selected please select another attachment type.",
            t22: {
              t1: "ID Number",
              t2: "DOB",
              btn1: "Validate ID",
            ...
            btn3: "Ok",
            t44:'Please enter valid national ID',
            t45:'Please enter valid Iqamah ID',
            t46:'National ID starts with 1',
            t47:'Iqamah ID starts with 2',
            t48:'Please enter valid ID number'
        },
        step4:{
            t1:"Summary",
            t2:"Review the below information",
            t3:"De-registration Details",
            t4:"Request Type",
            t5:"Reason",
            t6:"Reason if selected Others",
            t7:"Start Date",
            t8:"End Date",
            t9:"Suspended filing period",
            t10:"Next filing period",
        ...
        step5:{
            t1:"VAT De-registration",
            t2:"Your VAT De-registration Application is submitted successfully",
            t3:"Name",
            t4:"Reference Number",
            t5:"Date",
            t6:"Go to Tax Management",
            t7:"Download Acknowledgement"
        }
      ...
      arb: {
        ...
        { 
         nav:{
            t1:"خدمات ضريبة القيمة المضافة>",
            t2:"تفاصيل إلغاء التسجيل في ضريبة القيمة المضافة",
            t3:"رجوع",
            t4:"إدارة الضرائب>"
         },
         nav1:{
          ...
          max: "كحد أقصى 5 ميجا بايت",
          filevalidationmsg:"حجم الملف المسموح به في المرفقات 5 ميجا",
          fileformatsupportmsg:"الرجاء إرفاق ملف من الامتدادت التالية فقط ",
          ok:"موافق",
          fileAttachType:"Please select Attachment Type"
         },
         step1:{
            t1:"تفاصيل إلغاء التسجيل",
            t2:"أكمل التفاصيل أدناه",
            t3:"نوع الطلب",
            t4:"إلغاء تسجيل حساب ضريبة القيمة المضافة",
            t5:"تعليق الالتزام بتقديم إقرارات ضريبة القيمة المضافة",
            t6:"تاريخ البدء",
            t7:"تاريخ الانتهاء",
            t8:"تاريخ النهاية لايكون قبل تاريخ البداية",
            t9:"فترة تعليق الالتزام",
            t10:"فترة تقديم الإقرار القادم",
            t11:"تاريخ الاستحقاق القادم",
            t12:"السبب",
            t13:"أخرى (الرجاء التوضيح)",
            btn1:"متابعة",
            btn2:"حفظ كمسودة",
            t14:"تاريخ بداية التعليق يجب أن يكون بعد يوم من تاريخ اخر فترة",
            t15:"لم يتم إنشاء ICR لـعقد ضريبة القيمة المضافة",
            taxpayer1:"تفاصيل المكلف",
            taxpayer2:"الرقم المميز",
            taxpayer3:"الاسم",
            taxpayer4:"الفرع الرئيسي",
            //taxpayer5:"رخصة السجل التجاري",
            taxpayer5:"رخصة / السجل التجاري",
            taxpayer6:"العنوان",
            taxpayer7:"تاريخ سريان ضريبة القيمة المضافة",
        popup1:{
            t1:"التعليمات والشروط",
            t2:"معلومات",
            t3:"ملاحظة: في حالة إلغاء التسجيل بسبب الإفلاس أو التصفية أو الاندماج أو الاستحواذ أو أي سبب آخر من الأسباب التي تتعلق بجميع أنواع الضرائب،يجب القيام بعملية إلغاء التسجيل من لوحة التحكم في أيقونة الزكاة والضرائب المباشرة -> تعديل التسجيل -> الايقاف (الايقاف النهائي للرقم المميز)",
            t4:"- تعبئة جميع المعلومات المطلوبة وإرفاق المستندات المؤيدة لذلك.",
            t5:"- يجب على مقدم الطلب التأكد من عدم وجود اقرار معلق أو دفعة مطلوبة أو طلب معلق من جانبه قبل تقديم الطلب.",
            t6:"أوافق على التعليمات والشروط وإكمال الخطوات",
            btn:"إلغاء التسجيل في ضريبة القيمة المضافة",
            },
         ...
         step2:{
            ...
            btn2:"حفظ كمسودة",
            ins1:"معلومات",
            ins2:"1- يجب ان لا يزيد عدد المرفقات عن 5 ملفات",     
            ins3:"2-يجب ان لا يتجاوز عدد المرفقات لعملية تقديم طلب التسجيل عن 5 مرفقات.",                   
            ins4:"3-الرجاء إرفاق ملف من الامتدادت التالية فقط DOC, DOCX, XLS, XLSX, PDF, JPG",
         },
        step3:{
            t1:"التعهد",
            t2:"أكمل التفاصيل أدناه",
            t3:"رقم الهوية",
            t4:"رقم الهوية",
            t41:"يسمح فقط بالأرقام",
            t42:"8 أرقام كحد أدنى",
            t43:"15 رقم كحد أقصى",
            t5:"التاريخ",
            t6:"اسم الشخص الذي يمكن الاتصال به",
            t61:"يسمح فقط الحروف الهجائية",
            t7:"أتعهد بأني مصرح لإكمال هذا النموذج للشخص الخاضع للضريبة وجميع المعلومات صحيحة",
            btn1:"متابعه",
            btn2:"حفظ كمسودة",
            placeholder1:"أدخل رقم الهوية",
            placeholder2:"أدخل اسم جهة الاتصال",
            placeholder3:"Choose Date",
            placeholder4:"اختر تاريخ البدء",
            placeholder5:"اختر تاريخ الانتهاء",
            already:"تم التحديد بالفعل يرجى تحديد نوع مرفق آخر.",
            t22: {
              t1: "رقم الهوية",
              t2: "تاريخ الميلاد",
              btn1: "التحقق من الهوية",
            ...
            btn3: "موافق",
            t44:'ادخل رقم هوية وطنية صحيح',
            t45:'ادخل رقم إقامة صحيح',
            t46:'National ID starts with 1',
            t47:'Iqamah ID starts with 2',
            t48:'تاريخ الميلاد غير صحيح'
        },
        step4:{
            t1:"ملخص",
            t2:"راجع المعلومات أدناه",
            t3:"تفاصيل إلغاء التسجيل في ضريبة القيمة المضافة",
            t4:"نوع الطلب",
            t5:"السبب",
            t6:"اذكر السبب إذا تم اختيار أخرى",
            t7:"تاريخ البدء",
            t8:"تاريخ الانتهاء",
            t9:"فترة تعليق الالتزام",
            t10:"فترة تقديم الإقرار القادم",
            ...
            t15:"رقم الهوية",
            t16:"التاريخ",
            t17:"اسم الشخص الذي يمكن الاتصال به",
            btn1:"تأكيد",
            btn2:"حفظ كمسودة",
            edit:"تعديل",
            t18:"إلى",
        ...
        step5:{
            t1:"إلغاء التسجيل في ضريبة القيمة المضافة",
            t2:"تم تقديم طلب إلغاء تسجيل ضريبة القيمة المضافة بنجاح",
            t3:"الاسم",
            t4:"رقم المرجع",
            t5:"التاريخ",
            t6:"انتقل إلى إدارة الضريبة",           
        }
