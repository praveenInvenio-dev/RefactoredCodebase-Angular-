export const excisetaxconstants = {
  langz: {
    eng: {
      ...
      {
        nav: {
          t1: "Tax Management > Excise Tax Services  >",
          t2: "Excise Tax De-registration",
          t3: "Back",
          continue: "Continue",
          edit: "Edit",
          confirm: "Confirm",
        ...
        step1: {
          t1: "Taxpayer Information",
          t2: "Complete the below details",
          t3: "TIN",
          t4: "Taxpayer's Full Name",
          t5: "FIN",
          t6: "Legal Name",
          t7: "Warehouse Details",
          t71: "Sr.No",
          t8: "Warehouse Type",
          t9: "Warehouse No",
          nodata: "No Data",
          ...
          popup: {
            ...
            t2: "The Excise Taxpayer is responsible for informing the Authority when all Tax Warehouses have been cancelled and all Excise Tax liabilities and fines have been paid. The Deregistration is finalized after the (former) Excise Taxpayer has informed the Authority of the aforementioned and the Authority approves the application after an inspection is conducted.",
            t3: "Once the Taxpayer informs the authority of the aforementioned, the Authority shall carry out an inspection. If during this inspection any unpaid Excise Liabilities are found, GAZT will not deregister the Taxpayer.",
            t4: "I agree with these Instructions and Conditions and can not choose the checkbox to start submitting the form.",
            btn: "Excise De-registration",
          }
        },
        step2: {
          t1: "De-registration Reason",
          t2: "Please select the reason for submitting the deregistration request. GAZT may require to provide additional information or supporting documents",
          t3: "Reason",
          t4: "Others",
        },
        step3: {
          ...
          t10: "Minimum 7 Digits",
          t11: "Maximum 15 Digits",
          t12: "Date",
          t13: "I undersigned is authorized to submit thos form as per Excise Tax  regulations and promises that all information contained here is true and correct",
          t14: "Only 40 charecters allowed",
          t15: "Please Enter Alphabet Characters only",
        },
        step4: {
          s1: {
            t1: "Summary",
            t2: "Review the below information",
            t3: "Taxpayer Information",
            t4: "TIN",
            t5: "Taxpayer's Full Name",
            t6: "FIN",
            t7: "Legal name of the entity",
          },
          s2: {
        ...
        step5: {
          t1: "Excise De-registration",
          t2: "Your Excise De-registration Application is submitted successfully",
          t3: "Name",
          t4: "Application Number",
          t5: "Date",
          dashboard: "Go to Dashboard",
        ...
        step6: {
          s1: {
            t1: "Confirmation",
            t2: "I declare that i have closed all my warehouses and paid all my dues for Excise Tax",
    ...
    arb: {
      ...
      {
        nav: {
          t1: "إدارة الضريبة > خدمات ضريبة السلع الانتقائية>",
          t2: "إلغاء التسجيل للضريبة الإنتقائية",
          t3: "رجوع",
          continue: "متابعه",
          edit: "تعديل",
          confirm: "تأكيد",
        ...
        step1: {
          ...
          btn3: "موافق",
          popup: {
            t1: "التعليمات و الشروط",
            t2: " المكلف هو المسؤول عن إبلاغ الهيئة عندما يتم إلغاء جميع المستودعات الضريبية ودفع جميع الإلتزامات والغرامات الضريبية. يتم الانتهاء من إلغاء التسجيل بعد أن يبلغ المكلف الهيئة بالمهام المذكورة أعلاه وموافقة الهيئة على الطلب بعد إجراء عملية التفتيش.",
            t3: "بعد أن يبلغ المكلف الهيئة ما سبق ذكره، تقوم الهيئة بإجراء التفتيش. إذا تم العثور على أي إلتزامات غير مدفوعة خلال عملية التفتيش، لن يتم إلغاء التسجيل للمكلف.",
            t4: "أوافق على هذه التعليمات والشروط ولا يمكنني اختيار خانة الاختيار لبدء إرسال النموذج.",
            btn: "إلغاء التسجيل للضريبة الإنتقائية",
          }
        },
        step2: {
          t1: "سبب إلغاء التسجيل",
          t2: "الرجاء تحديد سبب إرسال طلب إلغاء التسجيل. قد تطلب الهيئة العامة للزكاة والدخل تقديم معلومات إضافية أو مستندات داعمة",
          t3: "السبب",
          t4: "آخرى",
        },
        step3: {
          ...
          t10: "الأرقام فقط مسموح بها",
          t11: "15 رقم كحد أقصى",
          t12: "التاريخ",
          t13: "الموقع ادناه مصرح له بتسليم الطلب وفقا للوائح والاحكام الخاصة بالضريبة الإنتقائية و يتعهد بإن جميع المعلومات الواردة في هذه الوثيقة صحيحة وحقيقية",
          t14: "يسمح فقط بـ 40 حرفًا",
          t15: "الرجاء إدخال حروف فقط",
        },
        step4: {
          s1: {
            t1: "ملخص",
          ...
          s3: {
            t1: "سبب إلغاء التسجيل",
            t2: "السبب",
            t3: "في حالة تحديد آخرى يرجى ذكر السبب",
          },
          s4: {
            t1: "التعهد",
            t2: "ادخل اسم مسؤول الاتصال",
            t3: "الوظيفة",
            t4: "نوع الهوية",
            t5: "رقم الهوية",
            t6: "التاريخ",
            t7: "أوافق على",
            t8: "التعليمات و الشروط",
        ...
        step5: {
          t1: "إلغاء التسجيل للضريبة الإنتقائية",
          t2: "تم تقديم طلب إلغاء التسجيل ضريبة السلع الانتقائية بنجاح",
          t3: "الاسم",
          t4: "الرقم المرجعي",
          t5: "التاريخ",
          dashboard: "الذهاب إلى لوحة التحكم",
