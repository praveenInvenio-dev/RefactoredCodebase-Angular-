...
@Component({
  selector: 'app-new-appeal-refund',
  templateUrl: './new-appeal-refund.component.html',
  styleUrls: ['./new-appeal-refund.component.css']
})
export class NewAppealRefundComponent implements OnInit {
  dir: String = "ltr";
  labels: any;
