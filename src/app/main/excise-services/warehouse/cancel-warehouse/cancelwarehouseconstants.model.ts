export const cancelwarehouseconstants = {
  langz: {
    eng: {
      dir: "ltr",
      otp: {
      ...
      cancelwarehouse:
      {
        step1: {
          ...
          btn1: "Yes",
          btn2: "No",
          t3: "Choose the Forms in Draft / For Resubmission to process:",
          t4: "Select",
          t5: "Date",
          t6: "Application Number",
          t7: "Warehouse Name",
          t8: "Confirm",
          t9:"Warehouse Cancellation",
          t10:"Status",
          btn3: "Ok"
        },
        step2: {
          nav: {
            ...
            t2: "Cancel Warehouse License",
            t3: "Back",
            placeholder1: "FIN Number",
            placeholder2: "Reason For Cancelling",
            placeholder3: "Enter Contact Person Name",
            placeholder4: "Designation",
            placeholder5: "Enter Id Number",
            placeholder6: "Choose Date",
          },
          s1: {
            ...
            t4: "FIN",
            t5: "Business Name",
            t6: "In order to apply for the cancellation on the license for the tax warehouse, the taxpayer must comply with all regulations and general guidelines laid down by the GAZT.",
            t7: "Choose New Warehouse to Cancel",
            t8: "Expiry Date",
            t9: "Please provide detailed reasons below for cancelling the License",
            t10: "GAZT may require you to provide the documentary evidence to subtantiate your cancellation request",
            btn1: "Continue",
            btn2: "Save as Draft",
          },
          popup1: {
            t1: "Terms & Conditions",
            t2: "The Tax Warehouse licensee is responsible for informing the Authority when al Excise goods stored under the Tax Warehouse licensee has informed by the Authority of the aforementioned. Once the Tax Warehouse license has been cancelled,the Authority shall carry out an inspection of the (former) Tax Warehouse location. If during this inspection any Excise goods are found which have not been accounted for in a Tax return, or if no Excise Tax has been paid for these Excise goods by other means, holding these Excise goods outside of an Excise suspension arrangement is a violation of the Excise Tax Law and will result in penalties being imposed.",
            t3: "I agree with these condition and proceed further",
            btn1: "Continue",
          }
        },
        step3: {
          ...
          s1: {
            ...
            t3: "Contact Person Name",
            t4: "Only alphabets allowed",
            t5: "Designation",
            t6: "Only alphabets allowed",
            t7: "ID Type",
            t8: "ID Number",
            t81: "Only Digits allowed",
            t82: "Minimum 7 Digits",
            t83: "Maximum 15 Digits",
            t9: "Date",
            t10: "I undersigned is authorized to submit this form as per Excise Tax  regulations and promises that all information contained here is true and correct",
            t11: {
              t1: "ID Number",
              t2: "DOB",
              btn1: "Validate ID",
            },
            t12: "Only Digits allowed",
            t13: "Minimum 7 Digits",
            t14: "Maximum 15 Digits",
            t15: "Only 40 characters allowed",
            t16: "Only characters allowed",
            t17: "Only 132 characters allowed",
            btn1: "Continue",
            btn2: "Save as Draft",
        ...
        step4: {
          ...
          s1: {
            ...
            t3: "Warehouse Information",
            t4: "Edit",
            t5: "FIN",
            t6: "Business Name",
            t7: "Warehouse to Cancel",
            t8: "Expiry Date",
            t9: "Reasons for cancelling the License",
          },
          s2: {
            t1: "Declaration",
            t2: "Edit",
        ...
        step5: {
          s1: {
            t1: "Cancel Warehouse License",
            t2: "Your Warehouse License is cancelled successfully",
            t3: "Go to Dashboard",
        ...
        step6: {
          s1: {
            t1: "Confirmation",
            t2: "Dear Taxpayer, please confirm that the below activities are completed for issuing warehouse cancelation letter",
            t3:"Goods under suspension are moved",
            t4:"Return is submitted for the warehouse validity period",
            t5:"All dues are paid"
          },
        },
        step8:{
        ...
        step13: {
          t1: "Acknowledgement",
          t2: "GAZT acknowledges the receipt of your Cancel Warehouse License",
    ...
    arb: {
      ...
      cancelwarehouse:
      {
        step1: {
          ...
          btn1: "نعم",
          btn2: "لا",
          t3: "اختر النماذج في المسودة / لاعادة التقديم للمعالجة:",
          t4: "تحديد",
          t5: "التاريخ:",
          t6: "رقم الطلب",
          t7:  "اسم المستودع",
        ...
        step2: {
          nav: {
            ...
            t2: "إلغاء رخصة المستودع",
            t3: "رجوع",
            placeholder1: "الرقم الضريبي",
            placeholder2: "سبب الإلغاء",
            placeholder3: "أدخل اسم جهة الاتصال",
            placeholder4: "المسمى الوظيفي",
            placeholder5: "أدخل رقم الهوية",
            placeholder6: "Choose Date",
          },
          s1: {
            t1: "معلومات المستودع",
            ...
            t4: "الرقم الضريبي",
            t5: "اسم المنشأة",
            t6: "من أجل التقدم بطلب إلغاء رخصة المستودع الضريبي، يجب على الموظف الامتثال لجميع اللوائح والقوانين العامة التي وضعتها الهيئة العامة للزكاة والدخل.",
            t7: "اختر رخصة المستودع المراد إلغاءه",
            t8: "تاريخ الانتهاء",
            t9: "يرجى تقديم الأسباب التفصيلية أدناه لإلغاء الترخيص",
            t10: "قد تطلب منك الهيئة العامة للزكاة والدخل تقديم الأدلة المستندية لتقديم طلب الإلغاء الخاص بك",
            btn1: "التالي",
            btn2: "حفظ كمسودة",
          },
          popup1: {
            t1: "الشروط والأحكام",
            t2: "كون حامل رخصة المستودع الضريبي مسؤولا عن إبلاغ الهيئة عند إزالة جميع السلع الانتقائية المخزنة المتعلقة برخصة المستودع الضريبي وأي التزامات ضريبية ناتجة عن الإزالة، فضلا عن دفع أي غرامات والتزامات ضريبية أخرى معلقة ومتعلقة برخصة المستودع الضريبي. يتم الانتهاء من إلغاء المستودع الضريبي بعد أن يبلغ مالك رخصة المستودع الضريبي (السابق) الهيئة بما سبق ذكره.   بعد إلغاء رخصة المستودع الضريبي، ستقوم الهيئة بإجراء تفتيش لموقع المستودع الضريبي (السابق). إذا تم العثور خلال هذا التفتيش على أي سلع انتقائية لم يتم احتسابها في الإقرار الضريبي، أو إذا لم يتم دفع الضريبة الانتقائية للسلع الانتقائية بوسائل أخرى، فإن حيازة هذه السلع الانتقائية خارج اتفاق تعليق السلع الانتقائية هو انتهاك لقانون الضريبة الانتقائية، وسيؤدي إلى فرض عقوبات.",
            t3: "أوافق على هذه الشروط والأحكام للأنتقال الى الخطوة التالية",
            btn1: "المستودع لإلغاء",
          }
        },
        step3: {
          nav: {
          ...
          s1: {
            ...
            t3: "ادخل اسم مسؤول الاتصال",
            t4: "يسمح فقط الحروف الهجائية",
            t5: "الوظيفة",
            t6: "يسمح فقط الحروف الهجائية",
            t7: "نوع الهوية",
            t8: "رقم الهوية",
            t81: "يسمح فقط بالأرقام",
            t82: "7 أرقام كحد أدنى",
            t83: "15 رقم كحد أقصى",
            t9: "التاريخ",
            t10: "الموقع أدناه مخول بتقديم هذا النموذج وفقا للوائح الضريبة الانتقائية والتعهد بأن جميع المعلومات الواردة في هذه الوثيقة حقيقية وصحيحة",
            t11: {
              t1: "رقم الهوية",
              t2: "تاريخ الميلاد",
              btn1: "التحقق من الهوية",
            ...
            t13: "7 أرقام كحد أدنى",
            t14: "15 رقم كحد أقصى",
            t15: "يسمح فقط بـ 40 حرفًا",
            t16: "يسمح فقط الحروف الهجائية",
            t17: "يسمح فقط بـ 132 حرفًا",
            btn1: "التالي",
            btn2: "حفظ كمسودة",
          }
        },
        ...
        step5: {
          s1: {
            t1: "إلغاء رخصة المستودع",
            t2: "تم إلغاء نموذج رخصة مستودع بنجاح",
        ...
        step6: {
          s1: {
            t1: "تأكيد",
            t2: "عزيزي المكلف، يرجى التأكد من اكتمال الأنشطة التالية لإصدار إشعار إلغاء المستودع",
            t3:"تم نقل البضائع المعلقة",
            t4:"تم تسليم الإقرار لفترة صلاحية المستودع",
            t5:"تم دفع جميع المستحقات"
          },
        },
