export const requestreactivationconstants = {
    langz: {
      eng: {
        dir: "ltr",
        otp: {
        ...
        { 
         nav:{
            ...
            t2:"Request reactivation Tax Warehouse License",
            t3:"Back",
            confirm:"Confirm",
            placeholder1:"Enter revoke suspension license reason",
            placeholder2:"Choose Effective Date",
         },
         step1:{
            t1:"Warehouse Details",
            t2:"Complete the below Details",
            t3:"Warehouse",
            t4:"TIN No",
            t5:"Taxpayer's Name",
            t6:"Select warehouse License to be revoked",
            t7:"Reasons for suspension",
            t8:"Others",
            good1: "Taxpayer Did Not File His Excise Tax Return",
            good2: "Taxpayer Failed To Pay His Excise Tax",
            good3: "Taxpayer Did Not Meet His Administrative Obligations",
            good4: "Others",
            btn:"Continue",
        popup1:{
            t1:"Instructions",
            t2:"This application is used by GAZT and Taxpayer to revoke suspension of a warehouse License",
            t3:"Pleae select the suspended warehouse License, whose suspension is to revoked.",
            t4:"Only 1 warehouse License's suspension can be revoked at a time i.e separete forms need to be submitted for revocation of each warehouse License's suspension.",
            t5:"Please attach documents to support your revocation Application.",
            t6:'Multiple reasons for revocation can also be selected.if "others " is selected, Please provide a description. Even of Multiple option(s) are selected, description is optional.',
            t7:"Suspension of a warehouse License can't be revoked retrospectively.",
            t8:"Please read the instructions carefully and click on checkbox to proceed further.",
            btn:"Continue",
            },
            
         },
         step2:{
            t1:"Other Information",
            t2:"Review the below information",
            t3:"Warehouse Details",
            t4:"Tax warehouse License",
            t5:"Effective Date",
            t6:"Tax Warehouse Address",
            t7:"Tax warehouse Validity",
            btn:"Continue",
           
         },
         step3:{
            t1:"Revocation Details",
            t2:"Complete the below Details",
            t3:"Please select the reasons to revoke Suspension of the Excise Tax Warehouse License*",
            t4:"Excise Tax Returns Filed",
            t5:"Payment for Excise Tax Liability Performed",
            t6:"Administrative Obligation Met",
            t7:"Others",
            t8:"Please provide the reasons to revoke the suspension of Tax Warehouse License",
            t9:"Please enter the Effective Date of revocation",
            btn:"Continue",
         },
         step4:{
            t1:"Summary",
            ...
            t4:"TIN No",
            t5:"Taxpayer's Name",
            t6:"Warehouse License to be Revoked",
            t7:"Reasons for Suspension",
            t8:"Others",
            t9:"Warehouse Details",
            t10:"Tax Warehouse License",
            t11:"Effective Date",
            t12:"Tax Warehouse Address",
            t13:"Tax Warehouse Validity",
            t14:"Revocation Details",
            t15:"Reasons to Revoke Suspension of the Excise Tax Warehouse License",
            t16:"Reasons to revoke the suspension of Tax Warehouse License (Others)",
            t17:"Effective Date of Revocation",
            revokeName1: "Excise Tax Returns Filed",
            revokeName2: "Payment for Excise Tax Liability Performed",
            revokeName3: "Administrative Obligation Met",
            revokeName4: "Others",
            edit:"Edit",
            btn:"Confirm",
         },
         step5:{
            t1:"Request reactivation Tax Warehouse License",
            t2:"Your Request reactivation Tax Warehouse License successfully",
            t3:"Go to Dashboard",
         }
      ...
      arb: {
        ...
        { 
         nav:{
            ...
            t2:"طلب إعادة تفعيل رخصة مستودع ضريبي",
            t3:"رجوع",
            confirm:"تأكيد",
            placeholder1:"أدخل سبب إلغاء ترخيص التعليق",
            placeholder2:"Choose Effective Date",
         },
         step1:{
            t1:"تفاصيل المستودع",
            ...
            t4:"الرقم المميز",
            t5:"اسم المكلف",
            t6:"حدد رخصة المستودع الضريبي المراد إعادة تنشيطها",
            t7:"أسباب التعليق",
            t8:"آخرى",
            good1: "لم يقدم المكلف إقراره الضريبي",
            good2: "فشل المكلف في دفع ضريبة السلع الانتقائية",
            good3: "المكلف لم يدفع  إلتزاماته الضريبية",
            good4: "آخرى",
            btn:"متابعه",
        popup1:{
            t1:"التعليمات",
            t2:"يستخدم هذا النموذج من قبل الهيئة والمكلف لإعادة تنشيط رخصة مستودع ضريبي",
            t3:"يرجى تحديد رخصة المستودع الضريبي المعلقة، لإعادة تنشيطها.",
            t4:"يمكن إعادة تنشيط رخصة مستودع ضريبي واحد فقط في كل مره، أي أنه يجب تقديم طلب منفصل لإعادة تنشيط كل رخصة مستودع ضريبي.",
            t5:"يرجى إرفاق وثائق لدعم طلب إعادة التنشيط الخاص بكم.",
            t6:'يمكن اختيار أسباب متعددة لإعادة التنشيط. يرجى تقديم وصف إذا تم تحديد "آخرى".مع العلم ان الوصف اختياري عند اختيار خيارات متعددة.',
            t7:"لا يمكن إعادة تنشيط رخصة المستودع الضريبي بأثر رجعي.",
            t8:"يرجى قراءة الشروط و التعليمات بعناية والنقر على مربع الاختيار للانتقال إلى الخطوة التالية.",
            btn:"متابعه",
            },
         ...
         step2:{
            ...
            t3:"تفاصيل المستودع ",
            t4:"رخصة المستودع الضريبي",
            t5:"تاريخ السريان",
            t6:"عنوان المستودع الضريبي",
            t7:"صلاحية رخصة المستودع الضريبي",
            btn:"متابعه",
           
         },
         step3:{
            t1:"تفاصيل إعادة التنشيط ",
            t2:"أكمل التفاصيل أدناه",
            t3:"يرجى تحديد أسباب إعادة تنشيط رخصة المستودع الضريبي",
            t4:"تم تقديم إقرار الضريبة الإنتقائية",
            t5:"تم دفع مبالغ الضريبة الإنتقائية المستحقة ",
            t6:"تم استيفاء الالتزامات الإدارية",
            t7:"آخرى",
            t8:"يرجى تحديد أسباب إعادة تنشيط رخصة المستودع الضريبي",
            t9:"يرجى إدخال تاريخ السريان إعادة التنشيط ",
            btn:"متابعه",
         },
         step4:{
            t1:"ملخص",
            ...
            t8:"آخرى",
            t9:"تفاصيل المستودع",
            t10:"رخصة المستودع الضريبي",
            t11:"تاريخ السريان",
            t12:"عنوان المستودع الضريبي",
            t13:"صلاحية رخصة المستودع الضريبي",
            t14:"تفاصيل إعادة التنشيط",
            t15:"أسباب إلغاء تعليق رخصة مستودع الضريبة الانتقائية",
            t16:"أسباب إلغاء تعليق ترخيص المستودع الضريبي (أخرى)",
            t17:"تاريخ نفاذ الإلغاء",
            revokeName1: "إقرارات ضريبة السلع الانتقائية المقدمة",
            revokeName2: "مدفوعات ضريبية السلع الانتقائية ",
            revokeName3: "المكلف أدى التزاماته الضريبية",
            revokeName4: "آخرون",
            edit:"تعديل",
            btn:"تأكيد",
         },
         step5:{
            t1:"طلب إعادة تفعيل رخصة مستودع ضريبي",
            t2:"طلب إعادة تفعيل رخصة المستودع الضريبي بنجاح",
